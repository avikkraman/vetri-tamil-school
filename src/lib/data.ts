...
export const CLASS_LEVELS = [
  {
    ...
    icon: '🌱',
    description: 'A gentle, joyful welcome — children discover their first letters through songs, stories, and play.',
    descriptionTamil: 'மென்மையான, மகிழ்ச்சியான வரவேற்பு — குழந்தைகள் பாடல்கள், கதைகள், விளையாட்டு வழியாக தங்கள் முதல் எழுத்துக்களை கண்டறிகிறார்கள்.',
  },
  {
    id: 2,
    level: 'UKG',
    ...
    icon: '🌼',
    description: 'Children explore all 12 vowels and 18 consonants, take their first steps into compound letters, and build a warm vocabulary — colors, animals, and counting to one hundred.',
    descriptionTamil: 'குழந்தைகள் 12 உயிர் எழுத்துக்களும் 18 மெய் எழுத்துக்களும் கற்று, உயிர்மெய் எழுத்துக்களில் முதல் அடி எடுத்து வைத்து, வண்ணங்கள், விலங்குகள், நூறு வரை எண்ணுதல் என்று சொல்வளம் பெறுகிறார்கள்.',
  },
  {
    id: 3,
    level: 'Grade 1',
